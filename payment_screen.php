...
<script type="text/javascript">
            ...
            Stripe.setPublishableKey('pk_test_dUhGuWk6DyqT8Rqwm6STDHqd');
...
$fee = $_SESSION['lateFee'];
$error = '';
$success = '';
    
if ($_POST) {
  Stripe::setApiKey("sk_test_7qiFySH00KWIE0dpDUHbYYMK");
  ...
  if (empty($_POST['street']) || empty($_POST['city']) || empty($_POST['zip']))
    ...
    Stripe_Charge::create(array("amount" => $fee,
                                "currency" => "usd",
...
?>
  ...
  <!-- Form Name -->
  <legend>Pay Your Late Fees Online!</legend>
  ...
  <fieldset>
    ...
    <div class="panel panel-success">
      ...
      <div class="panel-body">
        <p>
            Please Logout of your account after you finish with your checkout and payments, Thank you!
        </p>
      </div>
    </div>
